...
<iframe src="/examples/flasher.html" width="100%" height="340" frameborder="0" style="border-radius:8px;margin-bottom:24px"></iframe>
...
| 项目 | 职责 | min 后大小 |
|---|---|---|
| [novajs](https://github.com/) | 反应式内核 | 9 KB |
| [nova-style](https://github.com/) | 原子 CSS | 12 KB |
